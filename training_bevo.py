'''
Train any encoder style model on babyLM using this script taken from huggingface run_clm.py
...
This script is the same as run_mlm.py except it loads our tokenizer.
'''
