...
python training_decoder.py --config_name facebook/opt-125m --tokenizer_name tokenizers/babylm_10m_uni_16k.model --train_file babylm_data/babylm_10M/train.txt --validation_file babylm_data/babylm_dev/dev.txt --per_device_train_batch_size 8 --per_device_eval_batch_size 8 --do_train --num_train_epochs 50 --warmup_ratio=0.0001 --weight_decay 0.1 --log_level error --learning_rate 1e-4 --do_eval --logging_steps 0.01 --eval_steps 0.02 --max_eval_samples 5000 --save_steps 0.2 --evaluation_strategy steps --output_dir opt_50epochs --report_to wandb --run_name opt_50epochs --overwrite_output_dir --overwrite_cache
